...
\begin{longtable}{l l p{8cm}}
    ...
    \rf[obstaculos_web]{Processamento e identificação de obstáculos}{
        O sistema web deve processar os dados recebidos do micromouse em tempo real para identificar a presença de paredes.
         Ao detectar um obstáculo, o software deve atualizar instantaneamente a estrutura de dados do labirinto na interface web.} \\
