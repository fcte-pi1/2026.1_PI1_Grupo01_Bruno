...
\begin{longtable}{l l p{8cm}}
    ...
    \rf[on_temp_ web]{Iniciar temporidazador ao iniciar percurso}{
         Ao iniciar o percurso, o temporizador deve ser ativado automaticamente. Ao reiniciar, o sistema deve resetar o cronômetro e garantir o envio imediato dos dados
          do percurso anterior para o banco de dados.} \\
    \rf[reset_temp_ web]{Reiniciar temporidazador ao reiniciar percurso}{
         Ao reiniciaro percurso, o sistema deve resetar o cronômetro } \\
    \rf[envio_dados_web]{Envio de dados ao finalizar percurso}{
