...
\begin{longtable}{l l p{8cm}}
    ...
    \rf[on_off_web]{Possuir botão para controle remoto de operação}{
        O sistema web deve possuir um botão que envia comandos para iniciar e reiniciar percursos remotamente. Ao iniciar, o temporizador deve ser ativado automaticamente. Ao reiniciar, o sistema deve resetar o cronômetro e garantir o envio imediato dos dados do percurso anterior para o banco de dados.} \\
    ...
    \rf[obstaculos_web]{Processamento e Identificação de Obstáculos}{
        O sistema web deve processar os dados recebidos do micromouse em tempo real para identificar a presença de paredes. Ao detectar um obstáculo, o software deve atualizar instantaneamente a matriz do labirinto na interface web.} \\
