...
Para o refinamento da estrutura do Micromouse, foram fabricados por impressão 3D, utilizando materiais PETG e PLA, três versões do chassi, duas versões da tampa do compartimento da bateria e dois suportes de fixação, conforme apresentado nas Figuras~\ref{fig:prot_chassis}, \ref{fig:prot_tampa} e \ref{fig:prot_suportes}.

%\begin{figure}[H]
    %\centering
    % Inserir imagens dos protótipos
   % \includegraphics[width=0.45\textwidth]{prototipos.jpg}
   % \includegraphics[width=0.45\textwidth]{chassi_solid.jpg}
   % \caption{Protótipos fabricados por impressão 3D e modelo do chassi desenvolvido em CAD.}
...
células com dimensões diferentes entre si. Para corrigir o problema, optou-se por reajustar
...
uma das 16 células passou a ser 16,125 x 16,125 cm. Dessa forma, o labirinto tornou-se
