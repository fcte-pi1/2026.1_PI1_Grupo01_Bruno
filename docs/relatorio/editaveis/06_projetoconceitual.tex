...
\subsection{Explicação da escolha das rodas}

No estudo e desenvolvimento de robôs móveis, o diâmetro da roda é um parâmetro geométrico fundamental que influencia diretamente o desempenho do sistema. Para o projeto específico do micromouse, recomenda-se a utilização de rodas de menor diâmetro, pois estas apresentam uma compatibilidade superior com os requisitos funcionais do robô. 
Como o ambiente de operação do micromouse consiste em um labirinto plano, estruturado e com dimensões restritas, a principal necessidade do projeto não é a superação de obstáculos, mas sim a execução de movimentos que sejam simultaneamente rápidos, precisos e bem controlados. As rodas menores se destacam nesse cenário por proporcionarem maior precisão de movimento, um benefício direto do menor deslocamento linear que geram a cada rotação. 
Esta redução no deslocamento linear aumenta a resolução do sistema de controle da plataforma. Com isso, o robô ganha a capacidade de realizar ajustes mais finos em sua trajetória, o que favorece correções precisas ao longo do percurso e minimiza o impacto de erros acumulados durante a navegação. Adicionalmente, as rodas de menor diâmetro possuem menor inércia, o que resulta em exigências menores de torque para o motor e garante respostas mais rápidas nos momentos de aceleração e desaceleração.
Dessa forma, conclui-se que as rodas menores oferecem o melhor controle para as correções de trajetória e se adequam perfeitamente às severas limitações dimensionais do labirinto. Para uma aplicação como o micromouse, essas características de precisão e estabilidade de movimento provam ser consideravelmente mais relevantes do que a capacidade de transpor irregularidades no terreno.
