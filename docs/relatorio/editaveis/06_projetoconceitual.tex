...
\subsection{Visão de Implementação de Software} 
    ...
    A Visão de Implementação descreve o sistema através de modulos que representam as tecnologias que serão utilizadas para implementar os requisitos elicitados em código real. Deste modo, o software foi estruturado em três camadas principais: \textit{Firmware}, \textit{Backend} e \textit{Frontend}.
