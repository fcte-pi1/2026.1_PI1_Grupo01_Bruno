...
\begin{itemize}
    ...
    \item \textbf{Visão de Dados do Software}
    ...
    O Diagrama de Estrutura de Documentos (Figura\ref{fig:diagrama_estrutura_documentos}) reflete a modelagem escolhida para otimizar as consultas do sistema web. A base de dados está dividida em duas coleções principais:
