...
\subsection{Visão lógica do sistema}
...
\begin{figure}[th]
    \centering
    \includegraphics[width=0.8\textwidth]{figuras/diagrama_classes.png}
    \captionsetup{font=footnotesize}
...
\subsection{Diagrama de Atividades de Software}
...
\subsection{Diagramas de Sequência do Software}
