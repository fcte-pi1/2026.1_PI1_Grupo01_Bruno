...
\begin{itemize}
   ...
   \item \textbf{\textit{Backlog} funcional do \textit{software}:}
    
    A modelagem funcional do sistema foi elaborada através do Diagrama de Casos de Uso, ilustrando as interações diretas entre os atores (Usuário e Micromouse) e a fronteira do Sistema XAROPi. 
    
    Para garantir a rastreabilidade e o entendimento completo das ramificações do sistema, a Tabela \ref{tab:casos_uso_resumo} detalha cada caso de uso principal do diagrama, mapeando seus relacionamentos de inclusão (\textit{include}) e extensão (\textit{extend}), juntamente com os requisitos funcionais (RFs) que os fundamentam.

    \begin{table}[h!] 
    \centering
    \caption{Detalhamento e Rastreabilidade dos Casos de Uso (Sistema Web).}
    \label{tab:casos_uso_resumo}
    \renewcommand{\arraystretch}{1.5}
    \footnotesize
    \begin{tabular}{|c|p{2.8cm}|p{1.5cm}|p{4cm}|p{3.5cm}|}
    \hline
    \textbf{ID} & \textbf{Caso de Uso Principal} & \textbf{Ator(es)} & \textbf{Relacionamentos (\textit{Includes / Extends})} & \textbf{Requisitos (RFs)} \\ \hline
    
    \textbf{UC01} & Iniciar Novo Trajeto & Usuário & \textit{Includes:} Enviar Comando, Selecionar Tipo de Labirinto, Monitorar Execução & [on\textunderscore{}off\textunderscore{}web], [on\textunderscore{}temp\textunderscore{}web], [tipo\textunderscore{}labirinto\textunderscore{}web] \\ \hline
    
    \textbf{UC02} & Reiniciar Trajeto & Usuário & \textit{Includes:} Resetar Dados de Execução, Enviar Comando & [on\textunderscore{}off\textunderscore{}web], [reset\textunderscore{}temp\textunderscore{}web] \\ \hline
    
    \textbf{UC03} & Abortar Trajeto & Usuário & \textit{Includes:} Enviar Comando & [on\textunderscore{}off\textunderscore{}web] \\ \hline
    
    \textbf{UC04} & Consultar Status da Bateria & Usuário & - & [resto\textunderscore{}bateria\textunderscore{}web] \\ \hline
    
    \textbf{UC05} & Monitorar Execução & Usuário, Micromouse & \textit{Includes:} Acompanhar Mapeamento do Labirinto, Receber Telemetria & [websocket], [map\textunderscore{}lab\textunderscore{}web], [mapeamento\textunderscore{}trajeto\textunderscore{}web], [obstaculos\textunderscore{}web], [obstaculos\textunderscore{}id\textunderscore{}web], [tempo\textunderscore{}web], [bateria\textunderscore{}consumida\textunderscore{}web] \\ \hline

    \textbf{UC06} & Consultar Histórico & Usuário & \textit{Extends:} Visualizar Detalhes, Filtrar Trajetos, Excluir Trajeto & [consulta\textunderscore{}bd] \\ \hline
    
    \textbf{UC07} & Detectar Conclusão do Trajeto & Micromouse & \textit{Includes:} Armazenar Dados do Trajeto, Atualizar Status do Trajeto & [status\textunderscore{}web], [vmedia\textunderscore{}web], [dados\textunderscore{}bd\textunderscore{}web], [salvar\textunderscore{}bd] \\ \hline
    \end{tabular}
    \end{table}

    \newpage 

    \textbf{Priorização MoSCoW:} 
    \begin{itemize}
        \item \textbf{Must Have:} Comunicação WebSocket estável [websocket], mapeamento lógico do labirinto [map\textunderscore{}lab\textunderscore{}web] e envio de comandos de controle (início/reset/abortar) [on\textunderscore{}off\textunderscore{}web].
        \item \textbf{Should Have:} Persistência de dados [salvar\textunderscore{}bd] e rotinas de acompanhamento de telemetria e bateria [tempo\textunderscore{}web, resto\textunderscore{}bateria\textunderscore{}web].
        \item \textbf{Could Have:} Filtros avançados no histórico de trajetos [consulta\textunderscore{}bd] e exibição de velocidade média calculada [vmedia\textunderscore{}web].
    \end{itemize}
